...
import CourtSelection from './components/Courts/CourtSelection';
    ...
    <AuthProvider> {/* Wrap everything with AuthProvider */}
      <Router>
        ...
        <Routes>
          ...
          <Route path="/facilities/:facilityId/courts" element={<CourtSelection />} />
          <Route 
            path="/reserve/:facilityId/court/:courtId" 
            element={
              <ProtectedRoute>
                <ReservationForm />
              </ProtectedRoute>
