"""
Django settings for sports_reservation_backend project.
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-rt$v(_82qg38yjxsxp6kf6o$ra^0+(lxj_^39lb4)%gdg2@7u5')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('DJANGO_DEBUG', 'True') == 'True'

ALLOWED_HOSTS = ['localhost', '127.0.0.1', '*']  # Update this with your domain in production
USE_TZ = True
...
INSTALLED_APPS = [
    ...
    'allauth',
    'allauth.account',
    'allauth.socialaccount',  # Required for dj-rest-auth registration
...
# If using credentials (cookies, auth headers)
CORS_ALLOW_CREDENTIALS = True
CSRF_TRUSTED_ORIGINS = [
    "http://localhost:3000",
]
ACCOUNT_EMAIL_VERIFICATION = 'none'
ROOT_URLCONF = 'sports_reservation_backend.urls'
REST_FRAMEWORK = {
...
if not DEBUG:
    DATABASES = {
        'default': {
            ...
            'NAME': os.environ.get('DB_NAME', 'sports_reservation'),
